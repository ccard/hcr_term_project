...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_interactive_markers_SOURCE_PREFIX /home/marshall/hcr_term_project/turtlebot/src/turtlebot_viz/turtlebot_interactive_markers)
  set(turtlebot_interactive_markers_DEVEL_PREFIX /home/marshall/hcr_term_project/turtlebot/devel)
  ...
  set(turtlebot_interactive_markers_INSTALL_PREFIX /home/marshall/hcr_term_project/turtlebot/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'turtlebot_interactive_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marshall/hcr_term_project/turtlebot/src/turtlebot_viz/turtlebot_interactive_markers/${idir}'.  Ask the maintainer 'Daniel Stonier <stonier@yujinrobot.com>' to fix it.")
    endif()
