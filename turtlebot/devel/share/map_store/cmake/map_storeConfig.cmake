...
if("TRUE" STREQUAL "TRUE")
  set(map_store_SOURCE_PREFIX /home/marshall/hcr_term_project/turtlebot/src/map_store)
  set(map_store_DEVEL_PREFIX /home/marshall/hcr_term_project/turtlebot/devel)
  ...
  set(map_store_INSTALL_PREFIX /home/marshall/hcr_term_project/turtlebot/install)
...
if(NOT "/home/marshall/hcr_term_project/turtlebot/devel/include" STREQUAL "")
  set(map_store_INCLUDE_DIRS "")
  set(_include_dirs "/home/marshall/hcr_term_project/turtlebot/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'map_store' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dave Hershberger <hersh@willowgarage.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'map_store' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marshall/hcr_term_project/turtlebot/src/map_store/${idir}'.  Ask the maintainer 'Dave Hershberger <hersh@willowgarage.com>' to fix it.")
    endif()
...
set(map_store_EXPORTED_TARGETS "map_store_generate_messages_cpp;map_store_generate_messages_lisp;map_store_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${map_store_dep}_FOUND)
      find_package(${map_store_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${map_store_dep} REQUIRED ${depend_list})
  endif()
