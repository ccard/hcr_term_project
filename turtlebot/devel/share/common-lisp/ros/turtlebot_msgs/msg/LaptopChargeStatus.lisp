...
(cl:defmethod cl:initialize-instance :after ((m <LaptopChargeStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaptopChargeStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_msgs-msg:<LaptopChargeStatus> is deprecated: use turtlebot_msgs-msg:LaptopChargeStatus instead.")))
...
(cl:defmethod voltage-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_msgs-msg:voltage-val is deprecated.  Use turtlebot_msgs-msg:voltage instead.")
  (voltage m))

(cl:ensure-generic-function 'rate-val :lambda-list '(m))
(cl:defmethod rate-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_msgs-msg:rate-val is deprecated.  Use turtlebot_msgs-msg:rate instead.")
  (rate m))

(cl:ensure-generic-function 'charge-val :lambda-list '(m))
(cl:defmethod charge-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_msgs-msg:charge-val is deprecated.  Use turtlebot_msgs-msg:charge instead.")
  (charge m))

(cl:ensure-generic-function 'capacity-val :lambda-list '(m))
(cl:defmethod capacity-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_msgs-msg:capacity-val is deprecated.  Use turtlebot_msgs-msg:capacity instead.")
  (capacity m))

(cl:ensure-generic-function 'design_capacity-val :lambda-list '(m))
(cl:defmethod design_capacity-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_msgs-msg:design_capacity-val is deprecated.  Use turtlebot_msgs-msg:design_capacity instead.")
  (design_capacity m))

(cl:ensure-generic-function 'percentage-val :lambda-list '(m))
(cl:defmethod percentage-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_msgs-msg:percentage-val is deprecated.  Use turtlebot_msgs-msg:percentage instead.")
  (percentage m))

(cl:ensure-generic-function 'charge_state-val :lambda-list '(m))
(cl:defmethod charge_state-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_msgs-msg:charge_state-val is deprecated.  Use turtlebot_msgs-msg:charge_state instead.")
  (charge_state m))

(cl:ensure-generic-function 'present-val :lambda-list '(m))
(cl:defmethod present-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_msgs-msg:present-val is deprecated.  Use turtlebot_msgs-msg:present instead.")
  (present m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LaptopChargeStatus>)))
  ...
  "turtlebot_msgs/LaptopChargeStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LaptopChargeStatus)))
  "Returns string type for a message object of type 'LaptopChargeStatus"
  "turtlebot_msgs/LaptopChargeStatus")
